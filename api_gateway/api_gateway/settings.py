...
The API Gateway is intentionally lightweight: it mainly proxies requests to the
backend microservices and serves a small HTML landing page.
"""
...
SECRET_KEY = 'django-insecure-^knpu6#6c@y5gd#pw=$y(z7t)mcjcoeicp$0=fc2-t!h#ko-t_'
...
# SQLite is fine for the gateway itself (no business data here).
DATABASES = {
    'default': {
